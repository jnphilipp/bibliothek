    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', papers.models.TextFieldSingleLine(unique=True, verbose_name='Title')),
                ('volume', papers.models.TextFieldSingleLine(blank=True, null=True, verbose_name='Volume')),
