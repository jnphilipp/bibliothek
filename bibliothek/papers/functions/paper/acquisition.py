...
def delete(paper, acquisition_id):
    try:
        ...
        stdout.p([_('An acquisition with id "%(acquisition)s" for this paper does not exist.') % {'acquisition':acquisition_id}], after='=', positions=[1.])
...
def edit(paper, acquisition_id, field, value):
    ...
    try:
        ...
        stdout.p(['An acquisition with id "%(acquisition)s" for this paper does not exist.' % {'acquisition':acquisition_id}], after='=', positions=[1.])
