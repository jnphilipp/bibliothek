...
def delete(edition, acquisition_id):
    try:
        ...
        stdout.p([_('A acquisition with id "%(acquisition)s" for this edition does not exist.') % {'acquisition':acquisition_id}], after='=', positions=[1.])
...
def edit(edition, acquisition_id, field, value):
    ...
    try:
        ...
        stdout.p(['A acquisition with id "%(acquisition)s" for this edition does not exist.' % {'acquisition':acquisition_id}], after='=', positions=[1.])
