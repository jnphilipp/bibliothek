        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "alternate_title",
                    models.TextField(
                        blank=True, null=True, verbose_name="Alternate title"
                    ),
                ),
                (
                    "isbn",
            ...
            options={
                "ordering": (
                    django.db.models.expressions.Func(
                        django.db.models.expressions.F("book__series__name"),
                        function="LOWER",
                    ),
                    "book__volume",
                    django.db.models.expressions.Func(
                        django.db.models.expressions.F("book__title"), function="LOWER"
                    ),
                    "publishing_date",
                ),
